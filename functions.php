<?php
	// Create connection
	$con = new mysqli("localhost", "root", "Shibaby1", "luxleases");
			...
			echo "
				<div class='col-xs-6 col-md-4'>
					<div class='grid-in'>
						...
						<a href='home.php?add_cart=$feat_pro_id'><button type='button' class='btn btn-secondary center-block'>Add to Cart</button></a>
					</div>
				</div>
			";
		}
					...
					echo "
						<div class='col-xs-6 col-md-4'>
							<div class='home-in'>
								...
								<a href='vehicles.php?add_cart=$pro_id'><button type='button' class='btn btn-secondary center-block'>Add to Cart</button></a>
							</div>
						</div>
					";
				}
